...
describe DepartamentosController do
  ...
  describe "GET index" do
    it "assigns all departamentos as @departamentos" do
      ...
      assigns(:departamentos).should eq([departamento])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested departamento as @departamento" do
      ...
      assigns(:departamento).should eq(departamento)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new departamento as @departamento" do
      ...
      assigns(:departamento).should be_a_new(Departamento)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created departamento as @departamento" do
        post :create, {:departamento => valid_attributes}, valid_session
        assigns(:departamento).should be_a(Departamento)
        assigns(:departamento).should be_persisted
      end

      it "redirects to the created departamento" do
        post :create, {:departamento => valid_attributes}, valid_session
        response.should redirect_to(Departamento.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved departamento as @departamento" do
        ...
        Departamento.any_instance.stub(:save).and_return(false)
        post :create, {:departamento => { "nombre" => "invalid value" }}, valid_session
        assigns(:departamento).should be_a_new(Departamento)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested departamento" do
        departamento = Departamento.create! valid_attributes
        # Assuming there are no other departamentos in the database, this
        # specifies that the Departamento created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Departamento.any_instance.should_receive(:update).with({ "nombre" => "MyString" })
        put :update, {:id => departamento.to_param, :departamento => { "nombre" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the departamento" do
        departamento = Departamento.create! valid_attributes
        put :update, {:id => departamento.to_param, :departamento => valid_attributes}, valid_session
        response.should redirect_to(departamento)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the departamento as @departamento" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Departamento.any_instance.stub(:save).and_return(false)
        put :update, {:id => departamento.to_param, :departamento => { "nombre" => "invalid value" }}, valid_session
        assigns(:departamento).should eq(departamento)
      end
