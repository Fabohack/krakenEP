  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved estado as @estado" do
        ...
        post :create, {:estado => { "nombre" => "invalid value" }}, valid_session
        assigns(:estado).should be_a_new(Estado)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested estado" do
        ...
        Estado.any_instance.should_receive(:update).with({ "nombre" => "MyString" })
        put :update, {:id => estado.to_param, :estado => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the estado as @estado" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Estado.any_instance.stub(:save).and_return(false)
        put :update, {:id => estado.to_param, :estado => { "nombre" => "invalid value" }}, valid_session
        assigns(:estado).should eq(estado)
      end
