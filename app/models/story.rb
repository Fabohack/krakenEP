class Story < ActiveRecord::Base
  ...
  CSV_HEADERS = [
    "Id", "Tarea","Etiquetas","Iteracion","Inicio de iteracion","Fin Iteracion",
    "Tipo de tarea","Tiempo estimado","Estado actual","Creado por","Aceptado",
    "Fecha Tope","Solicitado por","Propietario","Descripcion","URL"
  ]
